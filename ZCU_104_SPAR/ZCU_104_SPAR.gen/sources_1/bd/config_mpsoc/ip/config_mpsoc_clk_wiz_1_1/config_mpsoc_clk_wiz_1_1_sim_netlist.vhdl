...
-- Command     : write_vhdl -force -mode funcsim -rename_top config_mpsoc_clk_wiz_1_1 -prefix
--               config_mpsoc_clk_wiz_1_1_ config_mpsoc_clk_wiz_1_1_sim_netlist.vhdl
...
entity config_mpsoc_clk_wiz_1_1_config_mpsoc_clk_wiz_1_1_clk_wiz is
  port (
...
end config_mpsoc_clk_wiz_1_1_config_mpsoc_clk_wiz_1_1_clk_wiz;

architecture STRUCTURE of config_mpsoc_clk_wiz_1_1_config_mpsoc_clk_wiz_1_1_clk_wiz is
  signal clk_in1_config_mpsoc_clk_wiz_1_1 : STD_LOGIC;
  signal clk_out1_config_mpsoc_clk_wiz_1_1 : STD_LOGIC;
...
clkin1_ibufds: unisim.vcomponents.IBUFDS
    generic map(
      ...
      I => clk_in1_p,
      IB => clk_in1_n,
      O => clk_in1_config_mpsoc_clk_wiz_1_1
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_config_mpsoc_clk_wiz_1_1,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_config_mpsoc_clk_wiz_1_1,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_config_mpsoc_clk_wiz_1_1,
...
entity config_mpsoc_clk_wiz_1_1 is
  ...
  attribute NotValidForBitStream of config_mpsoc_clk_wiz_1_1 : entity is true;
end config_mpsoc_clk_wiz_1_1;

architecture STRUCTURE of config_mpsoc_clk_wiz_1_1 is
begin
inst: entity work.config_mpsoc_clk_wiz_1_1_config_mpsoc_clk_wiz_1_1_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
